var checkDocumentWCAG = function () {
    ...
    function luminance(color) {
        ...
        return 0.2126 * componentValue(r) + 0.7152 * componentValue(g)
            + 0.0722 * componentValue(b);
    }
    ...
    function addNote(tag, noteText, scaledSize) {
        ...
        //creates html structure to be injected into the DOM
         note = document.createElement("div");
         note.className = "wcag_note";

         img = document.createElement("img");
         img.className = "wcag_note_img";
         img.src = "http://localhost/cis223w/week4/wcag/warning.svg";
         img.alt = noteText;
         ...
         //injects our structure into html
         ...
         //adds events for when to inject the above structure
            //shows
    ...
    function checkContrast(tag, text, fore, back, sizeString, weight ) {
        ...
        noteText += "width:&nbsp;" + 0.75 * scaledSize + "px;";
        noteText += "height:&nbsp;" + 0.75 * scaledSize + "px;'></div><br>";
...
// so these comparison signs don't work if they are mere double ==
...
// so these comparison signs don't work if they are mere double ==
        ...
        // these comparison signs don't work if they are mere double ==
    ...
    return function checkDocumentWCAG() {
        removeNotes();
